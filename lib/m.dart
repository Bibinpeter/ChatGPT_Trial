...
class MySettings {
  ...
  MySettings({required this.chatGptTurns});
}

final mySettingsProvider =
    StateProvider<MySettings>((ref) => MySettings(chatGptTurns: 0));
...
class _ChatGptExampleState extends ConsumerState<ChatGptExample> {
  static const _apiKey =
      String.fromEnvironment('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');
          ...
          children: [
            Consumer(
              builder: (context, ref, child) {
                final chatGptTurns = ref.watch(mySettingsProvider).chatGptTurns;
                return Text('$chatGptTurns free turns left');
              },
            ),
          ],
        )
